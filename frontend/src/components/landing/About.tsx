...
const About = () => {
	return (
		<div id="about" className="mt-16 w-full items-center justify-center p-4">
			<div className="w-full flex flex-col gap-1 items-center justify-center">
				<h1 className="text-[39px] lg:text-[50px] text-secondary">About</h1>
				<p className="text-subhead">What is Neural Cortex? Know about Us!</p>
			</div>
			...
			<div className="flex flex-col lg:flex-row gap-4 lg:gap-8 mt-10 items-center justify-center">
				...
				<div className="flex flex-col items-center justify-center lg:items-start gap-2 mt-5 lg:mt-0">
					<h1 className="text-tertiary text-4xl lg:text-5xl text-center">Welcome to <span className="!text-cyan-400">Neural Cortex</span></h1>
					<p className="para lg:!text-left !font-sans">
