...
const LandingNavbar = () => {
	...
	return (
		<nav className="absolute left-0 top-0 w-full z-20">
			<div className="py-2 px-8 w-full text-white flex items-center justify-between glassmorphic">
				<div className="flex items-center gap-3">
					<img src="/Logo.jpg" alt="logo" className="w-[45px] rounded-full" />
					<span className="text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-white to-cyan-400">Neuron Cortex</span>
				</div>
